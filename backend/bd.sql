...
CREATE TABLE adopciones (
    ...
    FOREIGN KEY (id_cliente) REFERENCES clientes(id_cliente),
    FOREIGN KEY (id_mascota_adopcion)
        REFERENCES mascotas_adopcion(id_mascota_adopcion)
);
...
CREATE TABLE servicios (
    ...
    FOREIGN KEY (id_categoria_servicio)
        REFERENCES categorias_servicios(id_categoria_servicio)
);
...
CREATE TABLE inventario (
    ...
    FOREIGN KEY (id_variante_producto)
...
CREATE TABLE direcciones (
    ...
    id_cliente INT,
    tipo_dirrecion ENUM ('DOMICILIO', 'COMERCIO') NOT NULL,
    calle VARCHAR(85),
    numero VARCHAR(85),
    piso VARCHAR(85),
